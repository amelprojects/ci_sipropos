...
class M_info extends CI_Model {
    ...
    var $table = 'info';
    var $column_order = array(null, 'judul', 'isi', 'date_created'); //set column field database for datatable orderable
    var $column_search = array('judul', 'isi', 'date_created'); //set column field database for datatable searchable 
